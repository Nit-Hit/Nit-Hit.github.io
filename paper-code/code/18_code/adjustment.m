...
% ------cye7@jhu.edu
function [output,Coeff]=adjustment(num,ID,LowAmyIndex)
...
for i =1:size(num,2)
    ...
    fittable = table(X_vec_Low,age_Low,sex_Low);
   
    %fittable.sex = nominal(fittable.sex);
    lm2 = fitlm(fittable,'linear','ResponseVar','X_vec_Low');
